...
const benefits = [
  {
    ...
    description: "Beautiful, modern websites that capture your brand identity and impress visitors from Indore and beyond.",
  },
  {
    icon: Smartphone,
  ...
  },
  {
    ...
    description: "Optimized for speed and performance to provide the best user experience and SEO rankings.",
  },
  {
    icon: TrendingUp,
    title: "Conversion Focused",
    description: "Designed to convert visitors into customers with strategic layouts and clear calls to action.",
  },
];
        ...
        <div className="container mx-auto container-padding relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              Our web design services help Indore businesses make a powerful first 
        ...
        <div className="container mx-auto container-padding">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
              Websites That Work for <span className="text-gradient">Indore Businesses</span>
            </h2>
            <p className="text-lg text-muted-foreground">
              We build beautiful, functional websites that help businesses in 
              Indore and Madhya Pradesh succeed online.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto container-padding">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                Complete Web Solutions for <span className="text-gradient">Indore Businesses</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-8">
                From simple business websites to complex ecommerce platforms, we deliver 
                web design solutions tailored for businesses in Indore.
              </p>
            ...
            >
              ...
              <p className="text-muted-foreground mb-6">
                Tell us about your project and get a custom quote for your new website.
              </p>
        ...
        <div className="container mx-auto container-padding text-center">
          ...
          >
            ...
            <p className="text-xl text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
              Partner with the best web design agency in Indore. Let us build your dream website.
            </p>
