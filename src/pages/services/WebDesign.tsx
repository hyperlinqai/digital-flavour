...
const benefits = [
  {
    ...
    description: "Beautiful, modern websites that capture your brand identity and impress visitors.",
  },
  {
    icon: Smartphone,
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                Websites That Work for <span className="text-gradient">Your Business</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-8">
                We build beautiful, functional websites that help businesses
                succeed online.
              </p>
            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-muted-foreground">Load Speed</p>
        ...
        <div className="container mx-auto container-padding">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                Complete Web Solutions for <span className="text-gradient">Your Business</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-8">
                From simple business websites to complex ecommerce platforms, we deliver
                web design solutions tailored for businesses.
              </p>
        ...
        <div className="container mx-auto container-padding text-center">
          ...
          >
            ...
            <p className="text-xl text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
              Partner with the best web design agency. Let us build your dream website.
            </p>
