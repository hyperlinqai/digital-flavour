      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-background via-secondary/30 to-background relative overflow-hidden">
        ...
        <div className="container mx-auto container-padding relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <span className="inline-flex items-center gap-2 bg-accent rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-accent-foreground text-sm font-medium">
                  Ecommerce Marketing Agency in Indore
                </span>
              </span>
            </motion.div>
            ...
            >
              Best Ecommerce Marketing Agency in{" "}
            ...
            >
              ...
              We help Indore businesses drive more traffic, increase sales, and build 
        ...
        <div className="container mx-auto container-padding">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
              Scale Your Online Store in <span className="text-gradient">Indore</span>
            </h2>
            <p className="text-lg text-muted-foreground">
              We help ecommerce businesses in Indore and across India achieve 
        ...
        <div className="container mx-auto container-padding">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                Complete Ecommerce Solutions for <span className="text-gradient">Indore Businesses</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-8">
                From product listings to conversion optimization, we provide comprehensive 
                ecommerce marketing services for online stores in Indore.
              </p>
        ...
        <div className="container mx-auto container-padding text-center">
          ...
          >
            ...
            <p className="text-xl text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
              Partner with the best ecommerce marketing agency in Indore. Let us help you achieve record sales.
            </p>
